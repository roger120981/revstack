...
config :revstack, RevstackWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: RevstackWeb.ErrorHTML, json: RevstackWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Revstack.PubSub,
  live_view: [signing_salt: "9dm6xPsO"]
...
config :revstack, Revstack.Mailer, adapter: Swoosh.Adapters.Local
